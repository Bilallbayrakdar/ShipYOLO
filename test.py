...
from utils.loss import compute_loss, compute_loss_hx
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            if training:  # if model has loss hyperparameters
                loss += compute_loss_hx([x.float() for x in train_out], targets, model)[1][:3]  # box, obj, cls
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/wsodd.yaml', help='*.data path')
    ...
    parser.add_argument('--names', type=str, default='data/wsodd.names', help='*.cfg path')
