...
#                         # tb_writer.add_graph(model, imgs)  # add model to tensorboard
        ...
        if rank in [-1, 0]:
            ...
            # Save model
            print("save...pth")
            if results[2] > hanxu_max:
                hanxu_save = opt.logdir + "/best.pth"
                torch.save(model.state_dict(), hanxu_save)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov4-RepVGGUnit-RFB-FPN-cbam.cfg', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov4-RepVGGUnit-RFB-FPN-cbam-512', help='renames results.txt to results_name.txt if supplied')
    ...
    parser.add_argument('--logdir', type=str, default='runs-new/', help='logging directory')
