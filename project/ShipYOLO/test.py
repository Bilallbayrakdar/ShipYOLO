...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/best-yolo-my-416.pth', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/ship.yaml', help='*.data path')
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov4-RepVGGUnit-RFB-FPN-cbam.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str, default='data/ship.names', help='*.cfg path')
