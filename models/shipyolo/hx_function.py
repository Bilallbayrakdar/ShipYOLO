...
class BasicRFA(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1, scale = 0.1):
        ...
        # self.maxpool0 = nn.MaxPool2d(kernel_size=5, stride=stride, padding=2)
        self.branch1 = nn.Sequential(
...
class DownFuseStage(nn.Module):
    ...
    def __init__(self, channels):
        ...
        #     Conv2dBatchLeaky(in_channels=self.channels, out_channels=self.channels * 2, kernel_size=3, stride=1, pad=1),
        #     BlurPool(self.channels * 2)
        # )
