...
try:
    from models.shipyolo.backbone import HX_RCSPDarknet
    from models.shipyolo.neck import HX_AtFPN
    from models.shipyolo.head import YOLOLayer
    from models.shipyolo.hx_function import Conv2dBatchLeaky, initialize_weights
except:
    from backbone import HX_RCSPDarknet
    from neck import HX_AtFPN
    from head import YOLOLayer
    from hx_function import Conv2dBatchLeaky, initialize_weights

class ShipYOLO(nn.Module):
    def __init__(self, num_classes, deploy, torch_trt=False):
        super(ShipYOLO, self).__init__()
