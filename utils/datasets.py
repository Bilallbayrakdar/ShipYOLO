...
train_aug_transforms = A.Compose(
        [
            A.HueSaturationValue(hue_shift_limit=20, sat_shift_limit=30, val_shift_limit=20, always_apply=False, p=0.5),  # 色彩饱和度
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if True:
            img = train_aug_transforms(image=img)["image"]
            # flip up-down
